...
import { loadConsumptionSummary, loadConsumptionItems } from "~/lib/consumption-actions";
              ...
              <For each={items()}>
                {(item) => (
                  <div class={`p-4 rounded-lg border-2 ${
                    item.is_overdue ? 'border-error bg-error/5' : 'border-success bg-success/5'
                  }`}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card class="bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300">
            <Card.Body>
              ...
              <p class="text-sm text-base-content/70 mt-2">
                Explore detailed reports, consumption patterns, next allowed dates,
                and export data for medical consultations. Perfect for doctor visits.
              </p>
              <Card.Actions class="mt-4">
