...
export const NAV_KEYBINDINGS = {
  ...
  escape: {
    ...
    keys: ["Esc"],
    label: "Exit list",
    description: "Switch to path zone",
  },
  index: {
    key: "",
    keys: ["0"],
    label: "Index note",
    description: "Select folder's index note",
  },
} as const;
...
export const LIST_KEYBINDINGS = {
  followMode: {
    key: "Alt+f",
    label: "Follow mode",
    description: "Arrow keys select items as you navigate",
  },
} as const;
...
export const ITEM_KEYBINDINGS = {
  rename: {
    key: "F2",
    label: "Rename",
    description: "Rename the focused item",
  },
  createSibling: {
    key: "N",
    label: "New sibling note",
    description: "Create note at same level",
  },
  createSiblingFolder: {
    key: "Ctrl+Shift+N",
    label: "New sibling folder",
    description: "Create folder at same level",
  },
  createChild: {
    key: "Shift+N",
    label: "New child note",
    description: "Create note inside folder",
  },
  createChildFolder: {
    key: "Alt+Shift+N",
    label: "New child folder",
    description: "Create folder inside folder",
  },
  copyLink: {
    key: "y",
    label: "Copy link",
  ...
  paste: {
    key: "Ctrl+V",
    label: "Paste sibling",
    description: "Paste at same level",
  },
  pasteChild: {
    key: "Ctrl+Shift+V",
    label: "Paste child",
    description: "Paste inside folder",
  },
  delete: { key: "Delete", label: "Delete", description: "Delete item" },
  makeFolder: {
    key: "Ctrl+Shift+F",
    label: "Make folder",
    description: "Convert note to folder",
  },
  makeNote: {
    key: "Ctrl+Shift+G",
    label: "Make note",
    description: "Convert folder to note",
  },
} as const;
