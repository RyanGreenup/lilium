...
export const TreeView = (props: TreeViewProps) => {
  ...
  const contextValue = createMemo(
    (): TreeContextValue => ({
      ...
      onCollapseAllExceptFocused: operations.collapseAllExceptFocused,
      onCollapseAllExceptSelected: operations.collapseAllExceptSelected,
      onFoldCycle: operations.foldCycle,
      onRefreshTree: operations.refreshTree,
      onFocusAndReveal: operations.focusAndReveal,
      onCreateNew: operations.handleCreateNew,
      onDelete: operations.handleDelete,
      onHoistHere: others.onHoistHere,
