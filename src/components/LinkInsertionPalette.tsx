...
export const LinkInsertionPalette = (props: LinkInsertionPaletteProps) => {
  ...
  const dummyNotes: LinkItem[] = [
    ...
    { id: "2", title: "Forgejo/Indexing Markdown Repositories", path: "/note/2" },
    { id: "3", title: "Forgejo/Render Jupyter", path: "/note/3" },
    { id: "4", title: "Forgejo/Render Math", path: "/note/4" },
    { id: "5", title: "Forgejo/Render Math/Async Javascript and Callback", path: "/note/5" },
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div class="flex items-center justify-between border-b border-base-300 px-4 py-3">
            ...
            <h2 class="text-lg font-semibold flex-1 text-center">Add a link</h2>
                  ...
                  {(item) => (
                    <button
                      class={`w-full text-left px-3 py-2 rounded hover:bg-base-200 transition-colors ${
                        selectedItem()?.id === item.id ? "bg-primary/10 text-primary" : ""
                      }`}
