...
import { ITEM_KEYBINDINGS, LIST_KEYBINDINGS, NAV_KEYBINDINGS, getDisplayKeys, matchesKeybind } from "~/lib/keybindings";
...
function KeybindingHelp(props: { followModeActive: Accessor<boolean> }) {
